...
def turn():
    ...
    if height * width <= 750:
    ...
    elif height * width <= 1200:
        early_game_spawn = [UnitType.SOLDIER,UnitType.SOLDIER,UnitType.MOPPER]
        mid_game_spawn = [UnitType.SOLDIER, UnitType.SOLDIER , UnitType.MOPPER]
        end_game_spawn = [UnitType.SOLDIER, UnitType.MOPPER]
        mid_game_start = 106
        end_game_start = 256
        ...
        early_game_spawn = [UnitType.SOLDIER, UnitType.SOLDIER, UnitType.SOLDIER, UnitType.MOPPER]
        mid_game_spawn = [UnitType.MOPPER, UnitType.SOLDIER, UnitType.SOLDIER]
        end_game_spawn = [UnitType.SOLDIER, UnitType.MOPPER]
        mid_game_start = 151
        end_game_start = 271 
        if cur_round < 75:
